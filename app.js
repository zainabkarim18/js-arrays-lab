...
1) Use the `slice()` method to create a new array that contains 'sushi'
 and 'cupcake'.
...
console.log('Exercise 14 result:'+ num +" index i="+  indexI + " index j=" + indexJ);
